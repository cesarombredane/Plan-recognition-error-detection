...
probabilityDistribution::probabilityDistribution(unordered_map<int, unordered_map<int,float>> _distribution):distribution(_distribution) {}
...
// return one random element based on probabilityDistribution
